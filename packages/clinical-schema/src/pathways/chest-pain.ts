...
import { pathwayQuestionSchema, type PathwayQuestion, type PathwayQuestionInput } from '../pathway';
...
export const CHEST_PAIN_SOCRATES_PROFILE = {
  ...
  version: '1.0.0',
  dimensions: [
    socratesRel('SITE', true, 'q.chest_pain.site', ['q.chest_pain.site.opt.left', 'q.chest_pain.site.opt.right', 'q.chest_pain.site.opt.centre'], 'Site distinguishes cardiac from pleural and gastric causes.'),
    socratesRel('ONSET', true, 'q.chest_pain.onset', [], 'Onset timing is a core cardiac risk discriminator.'),
    socratesRel('CHARACTER', true, 'q.chest_pain.character', ['q.chest_pain.character.opt.pressure', 'q.chest_pain.character.opt.sharp', 'q.chest_pain.character.opt.burning', 'q.chest_pain.character.opt.heaviness', 'q.chest_pain.character.opt.tearing'], 'Pressure-like pain suggests cardiac cause; sharp or burning suggests pleural or gastric.'),
    socratesRel('RADIATION', true, 'q.chest_pain.radiation', ['q.chest_pain.radiation.opt.left_arm', 'q.chest_pain.radiation.opt.jaw', 'q.chest_pain.radiation.opt.back', 'q.chest_pain.radiation.opt.none'], 'Radiation to arm or jaw is a high-risk feature.'),
    socratesRel('ASSOCIATED', true, 'q.chest_pain.associated', ['q.chest_pain.associated.opt.breathlessness', 'q.chest_pain.associated.opt.sweating', 'q.chest_pain.associated.opt.nausea'], 'Associated symptoms determine acuity.'),
    socratesRel('TIMING', true, 'q.chest_pain.timing', ['q.chest_pain.timing.opt.continuous', 'q.chest_pain.timing.opt.intermittent', 'q.chest_pain.timing.opt.episodic', 'q.chest_pain.timing.opt.nocturnal', 'q.chest_pain.timing.opt.exertional'], 'Exertional pattern suggests cardiac origin.'),
    socratesRel('SEVERITY', false, 'q.chest_pain.severity', ['q.chest_pain.severity.opt.mild', 'q.chest_pain.severity.opt.moderate', 'q.chest_pain.severity.opt.severe', 'q.chest_pain.severity.opt.very_severe'], 'Severity informs urgency but never rules out a serious cause.'),
  ],
} as const;
...
export const CHEST_PAIN_SAFETY_QUESTIONS: readonly PathwayQuestion[] = [
  ...
  makeQuestion({
    ...
    rationale: 'Cold sweat with chest pain is a cardiac red flag and feeds a deterministic rule.',
  }),
  makeQuestion({
    ...
    rationale: 'Fainting with chest pain indicates possible haemodynamic compromise.',
  }),
  makeQuestion({
    ...
    rationale: 'Known ischaemic heart disease changes the interpretation of new chest pain.',
  }),
];
...
export const CHEST_PAIN_CHARACTERISATION_QUESTIONS: readonly PathwayQuestion[] = [
  ...
  makeQuestion({
    ...
    rationale: 'Sudden onset within hours is more urgent than pain present for weeks.',
  }),
  makeQuestion({
    ...
    options: [
      ...
      { key: 'q.chest_pain.character.opt.burning', conceptCodes: ['MK-SYM-047'] },
      { key: 'q.chest_pain.character.opt.heaviness' },
      { key: 'q.chest_pain.character.opt.tearing' },
    ],
    socratesDimensions: ['CHARACTER'],
    rationale: 'Pressure or heaviness suggests cardiac; burning suggests reflux; tearing suggests aortic.',
  }),
  makeQuestion({
    ...
    required: true,
    options: [
      { key: 'q.chest_pain.radiation.opt.left_arm', conceptCodes: ['MK-SYM-012'] },
    ...
    rationale: 'Radiation to the arm or jaw is a specific deterministic red-flag input.',
  }),
  makeQuestion({
    ...
    required: true,
    options: [
      { key: 'q.chest_pain.associated.opt.breathlessness', conceptCodes: ['MK-SYM-002'] },
      { key: 'q.chest_pain.associated.opt.sweating', conceptCodes: ['MK-SYM-005'] },
  ...
  makeQuestion({
    ...
    options: [
      ...
      { key: 'q.chest_pain.timing.opt.exertional', conceptCodes: ['MK-SYM-003'] },
    ],
  ...
  makeQuestion({
    ...
    options: [
      ...
      { key: 'q.chest_pain.severity.opt.very_severe', severity: 'VERY_SEVERE' },
    ],
    socratesDimensions: ['SEVERITY'],
    rationale: 'Severity informs urgency but never rules out a serious cause.',
  }),
  makeQuestion({
    ...
    rationale: 'Exertional onset refines the cardiac assessment when associated symptoms are present.',
  }),
  makeQuestion({
    ...
    socratesDimensions: ['EXACERBATING_RELIEVING'],
    rationale: 'Relief with rest supports a cardiac pattern; relief with antacid supports a gastric one.',
  }),
];