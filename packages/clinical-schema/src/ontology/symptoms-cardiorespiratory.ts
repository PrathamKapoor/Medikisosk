...
export const CARDIO_RESPIRATORY_SYMPTOMS: readonly ClinicalConcept[] = [
  ...
  symptom(
    ...
    'Sweating',
    'GENERAL',
    ['sweating', 'profuse sweating', 'cold sweat', 'excessive sweating', 'pasina', 'पसीना', 'घाम येणे', 'પરસેવો'],
  ...
  symptom(
    ...
    'Fainting',
    'NEUROLOGICAL',
    ['fainting', 'fainted', 'passed out', 'loss of consciousness', 'unconscious', 'blackout', 'behosh', 'बेहोशी', 'बेहोश होना'],
