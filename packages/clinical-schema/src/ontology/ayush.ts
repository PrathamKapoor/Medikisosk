...
export const DASHAVIDHA_LABELS: Record<
  DashavidhaItem,
...
> = {
  PRAKRITI: {
    name: "Prakriti",
    meaning:
      "Constitutional type — the individual\u2019s inherent physical and psychological make-up.",
  },
  VIKRITI: {
    name: "Vikriti",
    meaning:
      "Current imbalance — the deviation from the individual\u2019s own constitution.",
  },
  SARA: {
    name: "Sara",
    meaning:
      "Quality of tissues — the relative excellence of the body\u2019s dhatus.",
  },
  SAMHANANA: {
    name: "Samhanana",
  ...
  PRAMANA: {
    name: "Pramana",
    meaning:
      "Anthropometric measurement — body proportions against reference measures.",
  },
  SATMYA: {
    name: "Satmya",
...
export const AYUSH_CONCEPTS: readonly ClinicalConcept[] = [
  ayush(
    "MK-AYU-001",
    "Prakriti assessment recorded",
    ["prakriti", "prakruti", "constitution", "प्रकृति"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-002",
    "Vikriti assessment recorded",
    ["vikriti", "vikruti", "imbalance", "विकृति"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-003",
    "Sara assessment recorded",
    ["sara", "tissue quality", "सार"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-004",
    "Samhanana assessment recorded",
    ["samhanana", "body build", "संहनन"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-005",
    "Pramana assessment recorded",
    ["pramana", "anthropometry", "प्रमाण"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-006",
    "Satmya assessment recorded",
    ["satmya", "tolerance", "सात्म्य"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-007",
    "Sattva assessment recorded",
    ["sattva", "mental strength", "सत्त्व"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-008",
    "Ahara Shakti assessment recorded",
    ["ahara shakti", "appetite", "digestion", "आहार शक्ति"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-009",
    "Vyayama Shakti assessment recorded",
    ["vyayama shakti", "exercise capacity", "व्यायाम शक्ति"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-010",
    "Vaya assessment recorded",
    ["vaya", "age stage", "वय"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-020",
    "Ahara (diet) pattern recorded",
    ["ahara", "diet pattern", "आहार"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-021",
    "Vihara (lifestyle) pattern recorded",
    ["vihara", "lifestyle", "daily routine", "विहार"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-022",
    "Nidra (sleep) pattern recorded",
    ["nidra", "sleep pattern", "निद्रा"],
    ["PATH-AYUSH-DASHAVIDHA"],
  ),
  ayush(
    "MK-AYU-023",
    "Agni (digestive fire) recorded",
