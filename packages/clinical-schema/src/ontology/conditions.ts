...
function condition(
  ...
  return {
    ...
    display,
    synonyms: [...synonyms],
    standardCoding: icd10
      ? [{ system: ICD10, code: icd10.code, display: icd10.display }]
      : [],
    pathways: [],
...
export const CONDITION_CONCEPTS: readonly ClinicalConcept[] = [
  ...
  condition(
    ...
    {
      code: "I64",
      display: "Stroke, not specified as haemorrhage or infarction",
    },
  ...
  condition(
    ...
    {
      pathways: ["PATH-SPECIAL-POPULATIONS"],
      redFlagRelevant: true,
  ...
  condition(
    ...
    {
      code: "Z88",
      display: "Allergy status to drugs, medicaments and biological substances",
    },
    { redFlagRelevant: true },
  ),
  condition(
