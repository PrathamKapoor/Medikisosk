...
export const TOBACCO_CHEWING_STATUSES = [
  "NEVER",
  "CURRENT",
  "EX_USER",
  "UNKNOWN",
...
export const HISTORY_FACT_CONCEPTS: readonly ClinicalConcept[] = [
  ...
  historyFact(
    "MK-HIS-003",
    "Alcohol use",
    ["alcohol", "drinking", "liquor", "sharab", "शराब", "दारू"],
    "Asked separately from smoking.",
  ),
  historyFact("MK-HIS-004", "Diet pattern", [
    "diet",
    "food habit",
    "vegetarian",
    "non vegetarian",
  ...
  historyFact("MK-HIS-005", "Physical activity", [
    "exercise",
    "physical activity",
    "walking",
    "workout",
  ...
  historyFact("MK-HIS-006", "Sleep quality", [
    "sleep",
    "sleep disturbance",
    "insomnia",
    "neend",
  ...
  historyFact(
    "MK-HIS-007",
    "Salt intake",
    ["salt intake", "namak", "नमक"],
    "Relevant to hypertension management.",
  ),
  historyFact("MK-HIS-008", "Menstrual history", [
    "menstrual history",
    "periods",
  ...
  historyFact("MK-HIS-009", "Occupational exposure", [
  ...
  historyFact("MK-HIS-010", "Recent travel", [
    "recent travel",
    "travel history",
    "ghoomna",
    "यात्रा",
  ]),
  historyFact("MK-HIS-011", "Immunisation status", [
    "immunisation",
    "immunization",
    "vaccination",
    "teeka",
  ...
  historyFact("MK-HIS-012", "Recent hospitalisation", [
  ...
  historyFact("MK-HIS-013", "Previous surgery", [
    "previous surgery",
    "operation",
    "operative history",
    "shalya chikitsa",
  ...
  historyFact("MK-HIS-014", "Blood transfusion history", [
    "blood transfusion",
    "transfusion history",
    "khoon chadha",
    "रक्त संचारण",
  ...
  historyFact(
    ...
    "Any positive response triggers immediate human escalation. Never auto-resolved.",
  ),
];
