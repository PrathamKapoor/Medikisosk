...
export const mrIN: Catalogue = {
  ...
  'kiosk.identity.otp_sent': 'तुमच्या नोंदणीकृत मोबाइल क्रमांकावर OTP पाठवला आहे',
  ...
  'kiosk.identity.guest_notice': 'पाहुणा म्हणून तुमची माहिती फक्त या भेटीसाठी ठेवली जाईल',
  ...
  'consent.must_accept_to_continue': 'पुढे जाण्यासाठी उपचाराची संमती आवश्यक आहे',
...
// --- interview.* --------------------------------------------------------
  ...
  'interview.history.medical.ask_family': 'तुमच्या कुटुंबात कोणाला दीर्घकालीन आजार आहे का?',
  ...
  'interview.history.tobacco_chewing.ask': 'तुम्ही तंबाखू किंवा गुटखा चावता का?',
  ...
  'interview.closing.summary_ready': 'तुमचा सारांश काळजी घेणाऱ्या संघासाठी तयार आहे',
  ...
  'triage.red.staff_message': 'प्राधान्य तपासणी आवश्यक. तात्काळ वैद्यकीय तपासणी करा',
  ...
  'document.upload.instruction': 'कागद सपाट ठेवा, चांगला प्रकाश ठेवा आणि संपूर्ण पानाचा फोटो घ्या',
  ...
  'contradiction.lab_discordance': 'प्रयोगशाळेचा निकाल सांगितलेल्या मूल्याशी जुळत नाही',
  ...
  'auth.login.session_expired': 'तुमचे सत्र संपले आहे. कृपया पुन्हा साइन इन करा',
  ...
  'error.ai_unavailable': 'सहाय्यक सध्या उपलब्ध नाही. तुम्ही त्याशिवाय पुढे जाऊ शकता',
