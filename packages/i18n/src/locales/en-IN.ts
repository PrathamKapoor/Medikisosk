...
export const enIN: Catalogue = {
  ...
  'kiosk.identity.otp_sent': 'An OTP has been sent to your registered mobile number',
  ...
  'kiosk.identity.guest_notice': 'As a guest, your details will be kept only for this visit',
  'kiosk.identity.mock_notice': 'Demo mode: no real ABHA verification is performed',
  ...
  'kiosk.session_ended': 'Your session has ended. Please proceed to the counter',
  ...
  'consent.must_accept_to_continue': 'Consent for treatment is required to continue',
  ...
  'interview.chief_complaint.placeholder': 'For example: chest pain since this morning',
  'interview.history.medical.ask': 'Do you have any long-term medical conditions?',
  ...
  'interview.history.family.ask': 'Are there any illnesses that run in your family?',
  'interview.history.personal.ask': 'Tell me about your daily routine, work and sleep',
  ...
  'interview.notes.ask': 'Is there anything else you would like the doctor to know?',
  ...
  'triage.green.staff_message': 'Routine. Escalate immediately if the condition changes',
  ...
  'triage.red.staff_message': 'Priority assessment required. Immediate clinician review',
  ...
  'contradiction.lab_discordance': 'The laboratory result does not match the reported value',
  ...
  'q.fever.mosquito_exposure': 'Have you been somewhere with a lot of mosquitoes?',
  ...
  'q.headache.neuro_deficit': 'Do you have weakness, numbness or difficulty speaking?',
