...
export const ELECTROLYTE_SPECIAL_RULES: readonly RedFlagRule[] = [
  ...
  },
  {
    ...
    severity: 'RED',
    action: 'IMMEDIATE_HUMAN_TRIAGE',
    clinicalRationale: 'Severe hyponatraemia risks seizures and needs controlled correction.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
  },
  {
    ...
    severity: 'RED',
    action: 'IMMEDIATE_HUMAN_TRIAGE',
    clinicalRationale: 'Bleeding in pregnancy is an obstetric emergency until assessed.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
  },
  {
    ...
    trigger: {
      all: [{ pregnant: true }, { vitalAbove: { code: 'MK-VIT-001:SYSTOLIC', value: 140 } }],
    },
    evidenceRequired: ['MK-CON-014', 'MK-VIT-001:SYSTOLIC'],
    severity: 'AMBER',
    action: 'PRIORITY_CLINICIAN_REVIEW',
    clinicalRationale: 'Hypertension in pregnancy needs pre-eclampsia assessment.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
  },
  {
  ...
  },
  {
    ...
    severity: 'AMBER',
    action: 'PRIORITY_CLINICIAN_REVIEW',
    clinicalRationale: 'Syncope in the elderly carries injury and cardiac risk.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
    minAgeYears: 65,
  },
  {
    ...
    severity: 'AMBER',
    action: 'PRIORITY_CLINICIAN_REVIEW',
    clinicalRationale: 'Mechanism determines whether occult injury must be ruled out.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
  },
  {
