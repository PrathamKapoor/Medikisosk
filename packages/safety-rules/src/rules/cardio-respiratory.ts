...
export const CARDIO_RESPIRATORY_RULES: readonly RedFlagRule[] = [
  {
    ...
    trigger: { all: [{ hasSymptom: 'MK-SYM-001' }, { hasSymptom: 'MK-SYM-002' }] },
  ...
  },
  {
    ...
    trigger: { all: [{ hasSymptom: 'MK-SYM-001' }, { hasSymptom: 'MK-SYM-006' }] },
    evidenceRequired: ['MK-SYM-001', 'MK-SYM-006'],
    severity: 'RED',
    action: 'IMMEDIATE_HUMAN_TRIAGE',
    clinicalRationale: 'Syncope with chest pain indicates possible haemodynamic compromise.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
  },
  {
    ...
    trigger: { all: [{ hasSymptom: 'MK-SYM-001' }, { hasCondition: 'MK-CON-004' }] },
  ...
  },
  {
    ...
    severity: 'AMBER',
    action: 'PRIORITY_CLINICIAN_REVIEW',
    clinicalRationale: 'Exertional angina-equivalent in an older adult warrants cardiology review.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
    minAgeYears: 45,
  },
  {
    ...
    trigger: {
      all: [{ hasSymptom: 'MK-SYM-004' }, { hasSymptomAny: ['MK-SYM-006', 'MK-SYM-001'] }],
    },
  ...
  },
  {
    ...
    severity: 'RED',
    action: 'IMMEDIATE_HUMAN_TRIAGE',
    clinicalRationale: 'Hypoxia at this level needs immediate assessment regardless of cause.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
  },
  {
    ...
    severity: 'AMBER',
    action: 'PRIORITY_CLINICIAN_REVIEW',
    clinicalRationale: 'Low-normal saturation needs review, a step below frank hypoxia.',
    source: STARTER_SOURCE,
    version: RULE_SET_VERSION,
  },
];