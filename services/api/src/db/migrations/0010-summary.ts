...
export const MIGRATION_0010_SUMMARY = {
  ...
  async up(db: Kysely<unknown>): Promise<void> {
    ...
    await schema
      ...
      .addColumn("ungroundedClaimCount", "integer", (col) =>
    ...
    await schema
      ...
      .addColumn("id", "varchar(26)", (col) => col.primaryKey())
      .addColumn("summaryId", "varchar(26)", (col) =>
        col.notNull().references("summaries.id"),
      )
    ...
    await schema
      ...
      .addColumn("resolutionState", "varchar(16)", (col) =>
