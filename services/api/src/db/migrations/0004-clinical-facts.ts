...
export const MIGRATION_0004_CLINICAL_FACTS = {
  ...
  async up(db: Kysely<unknown>): Promise<void> {
    ...
    await schema
      ...
      .addColumn('durationApproximate', 'integer', (col) => col.notNull().defaultTo(0))
    ...
    await schema
      ...
      .addColumn('frequency', 'varchar(16)', (col) => col.notNull().defaultTo('UNKNOWN'))
      .addColumn('route', 'varchar(24)', (col) => col.notNull().defaultTo('UNKNOWN'))
      .addColumn('durationDays', 'integer')
      .addColumn('status', 'varchar(16)', (col) => col.notNull().defaultTo('CURRENT'))
