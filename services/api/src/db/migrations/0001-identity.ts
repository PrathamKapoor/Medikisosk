...
export const MIGRATION_0001_IDENTITY = {
  ...
  async up(db: Kysely<unknown>): Promise<void> {
    ...
    await schema
      ...
      .addColumn("softwareVersion", "varchar(48)", (col) =>
    ...
    await schema
      ...
      .addColumn("dobAccuracy", "varchar(24)", (col) =>
      ...
      .addColumn("preferredLanguage", "varchar(16)", (col) =>
        col.notNull().defaultTo("en-IN"),
      )
    ...
    await schema
      .createIndex("idx_patients_tenant")
      .on("patients")
      .columns(["tenantId"])
      .execute();
    await schema
    ...
    await schema
      ...
      .addColumn("kioskId", "varchar(26)", (col) =>
      ...
      .addColumn("transientArtifactsDeleted", "integer", (col) =>
