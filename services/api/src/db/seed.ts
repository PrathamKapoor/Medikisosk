...
export interface SeedReport {
  ...
  readonly consentVersions: readonly {
    version: string;
    locale: string;
    created: boolean;
  }[];
...
const STAFF = [
  ...
  {
    username: "nurse.mehta",
    displayName: "Nurse Mehta",
    password: "demo-pass-1234",
    roles: ["NURSE"],
  },
  {
    username: "triage.desk",
    displayName: "Triage Desk",
    password: "demo-pass-1234",
    roles: ["TRIAGE"],
  },
  {
    username: "admin.patil",
    displayName: "Admin Patil",
    password: "demo-pass-1234",
    roles: ["ADMIN"],
  },
] as const;
...
export async function seedBase(
  db: AppDatabase,
  pepper: string,
): Promise<Omit<SeedReport, "demoPatients" | "demoEncounters">> {
